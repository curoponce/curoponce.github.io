                            ...
                            <div class="card-block">
                                <div class="row">
                                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                      <h3>Editar Cliente: {{$persona -> nombre}} {{$persona -> a_paterno}} {{$persona -> a_materno}}</h3>
                                      @if (count($errors) > 0)
                              ...
                              {{Form::token()}}
                              <form action="{{url('cliente/update', $persona->id_persona)}}" method="POST" class="form-material m-t-40">
                              {{csrf_field() }}
                              <div class="row">
