                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Listado de Clientes <button class="btn btn-outline-primary btn-rounded" data-toggle="modal" data-target="#modalcrear"><i class="fa fa-check"></i>Nuevo</button></h4>
                                <hr>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h4 class="modal-title">Eliminar Cliente {{$per->nombre}} {{$per->a_paterno}} {{$per->a_materno}}</h4>
                                                                </div>
                                                                <hr>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                             <div class="form-group">            
                                                                               <center><p>¿estas seguro que desea eliminar a este cliente?</p></center>          
                                                                            </div>
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                ...
                                <div id="modalcrear" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            @endif
                                            <form action="{{url('ventas/cliente')}}" method="POST" class="form-material m-t-40">
                                            {{csrf_field() }}
                                            <div class="modal-body">
                                                <div class="row">
