...
{    
    ...
    public function index(Request $request)
    {
      if($request)
      {
        ...
        -> groupBy('i.id_ingreso', 'i.fecha_hora', 'p.nombre', 'p.a_paterno', 'i.tipo_comprobante', 'i.serie_comprobante', 'i.num_comprobante', 'i.impuesto', 'i.estado')->get();
    ...
    Session::flash('crear','Se ha creado el nuevo ingreso correctamente');
    ...
    public function destroy($id)
    {
      ...
      $ingreso -> update();
      Session::flash('borrar','Se ha cancelado este ingreso');
      return Redirect::to('compras/ingreso');
    }
